...
const COMPONENT_TIME_PICKER = `'use client'
...
const USAGE_TIME_PICKER = `import { TimePicker } from '...your path here'
...
export const Component = (): JSX.Element  => (
    <>
      ...
      <TimePicker
        ...
        onHourChange={(e) => console.log(e)}
        onChange={(e) => console.log(e)}
        onMinuteChange={(e) => console.log(e)}
        onPeriodChange={(e) => console.log(e)}
      />
    </>
)`
...
export function Content() {
  return (
    <div className="mt-4 space-y-10">
      <div className="rounded-3xl animate-fade-in relative dark:bg-stone-900/80 bg-white shadow-[rgba(0,_0,_0,_0.25)_0px_5px_50px_-12px]">
        ...
        <BlockCode fileName="page.tsx" codeBlock={USAGE_TIME_PICKER} />
      </div>
      <BlockCode fileName="timePicker.tsx" codeBlock={COMPONENT_TIME_PICKER} />
    </div>
  )
}
