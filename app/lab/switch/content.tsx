...
import { Switch } from '...your path here'
...
export const Component = (): JSX.Element  => (
    <>
      ...
      />
      <Switch>
        {(active) => <span>{active ? 'Active' : 'No active'}</span>}
      </Switch>
    </>
)
`
...
export function ContentSwitch() {
  return (
    <div className="mt-4 space-y-10">
      <div className="rounded-3xl bg-white animate-fade-in relative dark:bg-stone-900/80 shadow-[rgba(0,_0,_0,_0.25)_0px_5px_50px_-12px]">
        <div className="mx-auto py-6 px-7 gap-5 flex justify-center items-center">
          <Switch defaultValue={true} />
          <Switch
            thumbIcon={(e) =>
              e === true ? (
      ...
      <BlockCode fileName="Switch.tsx" codeBlock={codeBlock} />
    </div>
  )
}
