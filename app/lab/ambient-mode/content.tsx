...
import { AmbientModeVideo } from 'ui/lab'
import { BlockCode } from 'ui/components'

const COMPONENT_TIME_PICKER = `
'use client'
...
export const AmbientModeVideo: React.FC<AmbientModeVideoProps> = ({
  ...
  return (
    <section className={\`relative \${sectionClass}\`}>
      ...
      <canvas
        className="absolute pointer-events-none w-full h-full z-[0] inset-0 scale-125 blur-[50px] hidden dark:block opacity-70"
        ref={canvasRef}
      />
    </section>
  )
...
const USAGE_TIME_PICKER = `import { AmbientModeVideo } from '...your path here'
    ...
    <div className="mt-4 space-y-10">
      <div className="flex flex-col gap-5 items-center justify-center">
        <AmbientModeVideo
          ...
          canvasClass="blur-[100px]"
          src="/lab/ambient-2.mp4"
        />
      </div>
      <BlockCode fileName="page.tsx" codeBlock={USAGE_TIME_PICKER} />
      <BlockCode fileName="ambientMode.tsx" codeBlock={COMPONENT_TIME_PICKER} />
    </div>
  )
}
