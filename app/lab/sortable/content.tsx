...
import { Sortable, SortableItem } from 'ui/lab'
...
import { Sortable } from '...your path here'
...
export const Component = (): JSX.Element  => {
  ...
  return (
    <>
      <Sortable
          onChange={setItems}
          className="grid grid-cols-4 flex-wrap gap-2 justify-center font-semibold"
        >
          {items.map((e) => (
            <SortableItem
              className="w-full aspect-square bg-gradient-to-br from-purple-500 to-blue-500 grid place-content-center rounded-3xl"
              key={e}
              id={e}
            >
              {e}
        ...
        <Sortable
          onChange={setImgs}
          className="grid grid-cols-4 pt-4 gap-2 font-semibold"
        >
          {imgs.map((e, i) => (
            <SortableItem
...
export function Content() {
  ...
  return (
    <div className="mt-4 space-y-10">
      ...
      <BlockCode fileName="sortable.tsx" codeBlock={codeBlock} />
    </div>
  )
}
