...
export default function TestToast() {
  ...
  return (
    <article>
      <h2 className="font-medium tracking-tight text-2xl">useDebounce hook</h2>
      <div className="pt-10">
        ...
        <div className="relative ">
          <div className="absolute inset-0 select-none pointer-events-none bg-gradient-to-b dark:from-[#141210] from-white via-white/50 dark:via-[#141210] to-transparent dark:to-transparent"></div>
